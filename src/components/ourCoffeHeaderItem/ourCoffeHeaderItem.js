...
import './ourCoffeHeaderItem.css'

function OurCoffeHeaderItem() {
        return(
            <div className="coffeHeaderItem__block">
                <div className="coffelinkItem__items">
...
export default OurCoffeHeaderItem;